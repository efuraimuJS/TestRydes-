ActiveAdmin.register User do
  ...
  #
  permit_params do
    permitted = [:full_name, :uid, :avatar_url, :provider, :email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :confirmation_token, :confirmed_at, :confirmation_sent_at, :unconfirmed_email]
